...
To help you quickly understand the framework architecture and design principles, the following learning materials are available:

### Video Resources

- **[Scalable Test Automation](docs/resources/Scalable_Test_Automation.mp4)**: Video overview of scalable test automation strategies and patterns used in this framework

https://github.com/user-attachments/assets/e02b9455-2442-4119-86ea-9bc2a9d1fc81

### Documentation

- **[The Unified Automation Blueprint](docs/resources/The_Unified_Automation_Blueprint.pdf)**: Comprehensive PDF document covering the unified automation architecture and design principles

### Audio Resources

- **[Unifying API Web Native App Testing Architecture](docs/resources/Unifying_API_Web_Native_App_Testing_Architecture.m4a)**: Audio presentation explaining how the framework unifies API, Web, and Native App testing architectures

https://github.com/user-attachments/assets/4109bcd7-e089-4c4b-baa2-502f0c84067b

> **Note**: These learning materials were generated by Google notebookLM to provide comprehensive coverage of the framework's architecture and design patterns.
